...
@property (nonatomic, strong) NSMutableArray *rememberThisArrayForLater;

@property (nonatomic, copy) NSMutableArray *duplicateThisArrayForLater;

@property (assign) CGFloat rememberCGFloatForLater;
